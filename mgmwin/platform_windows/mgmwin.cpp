...
namespace mgm {
    ...
    MgmWindow::InputInterface winkey_to_input_interface(const WPARAM key) {
        switch (key) {
            case VK_LWIN:
            case VK_RWIN: return MgmWindow::InputInterface::Key_META;
    ...
    MgmWindow::InputInterface winchar_to_input_interface(const WPARAM key) {
        switch (key) {
            case 'A':
            case 'a': return MgmWindow::InputInterface::Key_A;
            case 'B':
            case 'b': return MgmWindow::InputInterface::Key_B;
            case 'C':
            case 'c': return MgmWindow::InputInterface::Key_C;
            case 'D':
            case 'd': return MgmWindow::InputInterface::Key_D;
            case 'E':
            case 'e': return MgmWindow::InputInterface::Key_E;
            case 'F':
            case 'f': return MgmWindow::InputInterface::Key_F;
            case 'G':
            case 'g': return MgmWindow::InputInterface::Key_G;
            case 'H':
            case 'h': return MgmWindow::InputInterface::Key_H;
            case 'I':
            case 'i': return MgmWindow::InputInterface::Key_I;
            case 'J':
            case 'j': return MgmWindow::InputInterface::Key_J;
            case 'K':
            case 'k': return MgmWindow::InputInterface::Key_K;
            case 'L':
            case 'l': return MgmWindow::InputInterface::Key_L;
            case 'M':
            case 'm': return MgmWindow::InputInterface::Key_M;
            case 'N':
            case 'n': return MgmWindow::InputInterface::Key_N;
            case 'O':
            case 'o': return MgmWindow::InputInterface::Key_O;
            case 'P':
            case 'p': return MgmWindow::InputInterface::Key_P;
            case 'Q':
            case 'q': return MgmWindow::InputInterface::Key_Q;
            case 'R':
            case 'r': return MgmWindow::InputInterface::Key_R;
            case 'S':
            case 's': return MgmWindow::InputInterface::Key_S;
            case 'T':
            case 't': return MgmWindow::InputInterface::Key_T;
            case 'U':
            case 'u': return MgmWindow::InputInterface::Key_U;
            case 'V':
            case 'v': return MgmWindow::InputInterface::Key_V;
            case 'W':
            case 'w': return MgmWindow::InputInterface::Key_W;
            case 'X':
            case 'x': return MgmWindow::InputInterface::Key_X;
            case 'Y':
            case 'y': return MgmWindow::InputInterface::Key_Y;
            case 'Z':
            case 'z': return MgmWindow::InputInterface::Key_Z;
    ...
    bool char_can_be_text_input(unsigned char c) {
        ...
        switch (u_msg) {
            ...
            case WM_MOUSEMOVE: {
                ...
                const vec2f posf = vec2f{static_cast<float>(pos.x), static_cast<float>(pos.y)}
                                       / vec2f{static_cast<float>(updating_window->window_size.x), static_cast<float>(updating_window->window_size.y)} * 2.0f
                                   - 1.0f;
